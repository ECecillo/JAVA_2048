...
public class Swing2048 extends JFrame implements Observer {
    ...
    public Swing2048(Jeu _jeu1, Jeu _jeu2) {
        jeu1 = _jeu1;
        jeu2 = _jeu2;
        ...
        setSize(jeu1.getSize() * PIXEL_PER_SQUARE * 2 + 100, jeu2.getSize() * PIXEL_PER_SQUARE);
        //pack();
        ...
        tabC1 = new JLabel[jeu1.getSize()][jeu1.getSize()];
        ...
        JPanel panel1 = new JPanel(new GridLayout(jeu1.getSize(), jeu1.getSize()));
        JPanel panel2 = new JPanel(new GridLayout(jeu2.getSize(), jeu2.getSize()));
        ...
        for (int i = 0; i < jeu1.getSize(); i++) {
            for (int j = 0; j < jeu1.getSize(); j++) {
                ...
                for (int i = 0; i < jeu1.getSize(); i++) {
                    for (int j = 0; j < jeu1.getSize(); j++) {
                        ...
                        if (c2 == null || c2.getValeur() == 0) {
                            ...
                            tabC2[i][j].setText(c2.getValeur() + "");
                            //tabC2[i][j].setText(c.getValeur() + ""); // On lui met une valeur 2 , 4 ....
                        }
