...
public class Swing2048 extends JFrame implements Observer {
    ...
    private JLabel[][] tabC; //On déclare un tableau pour créer le JPanel
    private Jeu jeu;
    boolean initializer;

    public Swing2048(Jeu _jeu, int _x, int _y) {
        jeu = _jeu;
        ...
        JPanel panel = new JPanel(new GridLayout(jeu.getSize(), jeu.getSize()));
